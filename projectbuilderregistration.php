...
if ($valid) {
    ...
    $stmt = $conn->prepare("INSERT INTO projectbuilder (BuilderName, PhoneNumber, Email, Address, Password, AadharCard, PanCard, Domicile,uploadprojectid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sisssssss", $BuilderName, $phoneNumber, $email, $address, $Password, $aadharCardPath, $panCardPath, $domicilePath,$uploadProjectId);
